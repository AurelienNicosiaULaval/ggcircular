...
estimated von Mises concentration parameter.
...
drawn directly on top of empirical rose diagrams.
...
- Local `devtools::check(document = FALSE, build_args = "--no-manual")` passes
