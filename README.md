...
[![License:
MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE) [![R
\>=
4.1.0](https://img.shields.io/badge/R-%3E%3D%204.1.0-276DC3.svg)](DESCRIPTION)
[![pkgdown
...
`stat_circular_topography()` estimates the conditional density of a real
response given an angle. `geom_phase_loom()` instead displays binned
conditional masses.
...
<img src="man/figures/README-circular-topography-layer-1.png" alt="" width="100%" />
...
<img src="man/figures/README-phase-loom-layer-1.png" alt="" width="100%" />

`stat_toroidal_topography()` estimates `f(phi | theta)`, while
`stat_toroidal_ridge()` extracts its first grid maximum and reports
local concentration. The ridge also computes
`after_stat(ridge_ambiguous)` from near-tied distinct local modes. A
ridge is not a substitute for the full topography when multimodality is
plausible.
...
<img src="man/figures/README-toroidal-topography-layer-1.png" alt="" width="100%" />
...
<img src="man/figures/README-toroidal-ridge-layer-1.png" alt="" width="100%" />
...
<img src="man/figures/README-axial-1.png" alt="" width="100%" />
...
<img src="man/figures/README-movement-1.png" alt="" width="100%" />
...
<img src="man/figures/README-mixture-1.png" alt="" width="100%" />
